...
public class Pen {
	 ...
	 * {@code other.getColor()} and it is on if {@code other.isOn()} is true and
	 * it is off if {@code other.isOn()} is false.
	 * 
	 * @param other
	 *            a pen to copy
	 */
	...
	/**
	 * Initialize this pen so that its color is equal to the specified color and
	 * it is on.
	 * 
	 * @param color
	...
	/**
	 * Draws a line using the color of this pen on a StdDraw object. No line is
	 * drawn if this pen is off.
	 * 
	 * @param from
	...
	/**
	 * Returns a string representation of this pen. The returned string is the
	 * color of this pen followed by " : " followed by "true" if this pen is on
	 * and "false" if this pen is off.
	 * 
	...
	/**
	 * Compares this pen to the specified object. The result is true if and only
	 * if the argument is not null and is a {@code Pen} object that has the same
	 * color as this pen and the same on-off state as this pen.
	 * 
	 * @param obj
	 *            the object to compare this Pen against
	 * @return true if the given object represents a Pen equivalent to this
